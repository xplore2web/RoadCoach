...
public interface VehicleTypeDao {
	/**
     * This method pass id as input and get the {@link VehicleType} from DAO layer
     *
     * @param id
    ...
    /**
     * This method pass driver as input and get the {@link VehicleType} from DAO layer.
     *
     * @param VehicleType
     * @return {@link VehicleType}
     * @throws ProcessFailed the process failed
    ...
    /**
     * This method pass VehicleType as input and updates the {@link VehicleType} from database
     *
     * @param VehicleType
     * @throws ProcessFailed the process failed
     */
    ...
    /**
     * This method pass id as input and deletes the {@link VehicleType} from DAO layer.
     *
     * @param id
     * @throws ProcessFailed the process failed
     */
