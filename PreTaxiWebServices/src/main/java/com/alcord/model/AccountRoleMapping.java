...
public class AccountRoleMapping implements Serializable {
	...
	@JoinColumn(name = "fkey_role_id", referencedColumnName = "id")
	@ManyToOne
	private Role fkeyRoleId;
	...
	public Role getFkeyRoleId() {
		return fkeyRoleId;
	}

	public void setFkeyRoleId(Role fkeyRoleId) {
		this.fkeyRoleId = fkeyRoleId;
	}
}
