...
public class CompanyBilling implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CompanyBilling)) {
            return false;
        }
        CompanyBilling other = (CompanyBilling) object;
    ...
    public String toString() {
        return "com.alcord.model.CompanyBilling[ id=" + id + " ]";
    }
