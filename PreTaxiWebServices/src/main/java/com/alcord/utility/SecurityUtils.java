...
import com.alcord.utility.StaticContextAccessor;
...
public final class SecurityUtils {
	...
	public static Account getCurrentlyLoggedInAccount() {
		Account user = StaticContextAccessor.getBean(AccountDao.class)
				.findByAccountName(getCurrentAccountLogin());
		if (user != null)
			return user;
    	return null;
    }
