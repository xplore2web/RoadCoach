...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        _dataSource.setDriverClassName(env.getProperty("db.driver"));
        _dataSource.setUrl(env.getProperty("db.url"));
        _dataSource.setUsername(env.getProperty("db.username"));
        _dataSource.setPassword(env.getProperty("db.password"));
        return _dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        LocalContainerEntityManagerFactoryBean _entityManagerFactory
                = new LocalContainerEntityManagerFactoryBean();

        _entityManagerFactory.setDataSource(dataSource);

        // Classpath scanning of @Component, @Service, etc annotated class
        _entityManagerFactory.setPackagesToScan(
                env.getProperty("entitymanager.packagesToScan"));

        // Vendor adapter
        HibernateJpaVendorAdapter vendorAdapter = new HibernateJpaVendorAdapter();
        _entityManagerFactory.setJpaVendorAdapter(vendorAdapter);
        ...
        _entityManagerFactory.setJpaProperties(additionalProperties);
