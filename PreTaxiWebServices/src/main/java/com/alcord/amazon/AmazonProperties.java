...
public class AmazonProperties {
    ...
    public static class SNS {
		...
		public void setAndroidApplicationArn(String androidApplicationArn) {
			this.androidApplicationArn = androidApplicationArn;
		}
		...
		public void setIosApplicationArn(String iosApplicationArn) {
			this.iosApplicationArn = iosApplicationArn;
		}

		@Override
        public String toString() {
            return "S3{" +
                    "android-application-arn='" + androidApplicationArn + '\'' +
                    "ios-application-arn='" + androidApplicationArn + '\'' +
                    '}';
        }
    }
